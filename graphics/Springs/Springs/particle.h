...
public:
	Particle();
	Particle(double pos_temp[DIM], double dir_temp[DIM], double radius_temp, bool anchored_temp);
	Particle(double x, double y, double xDir, double yDir, double radius_temp, bool anchored_temp);
...
void EulerStep(ParticleSystem & ps);
void MidpointStep(ParticleSystem & ps);
